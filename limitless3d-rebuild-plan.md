...
8. Etsy reviews auto-pull (§10, 2026-08-09): does Randy want it, and will he register an Etsy
   ...
   *Re-scoped 2026-08-12 (Ryan; same move as §9.7): the build no longer waits on Randy —
   ...
   provisional API keys work immediately), sequenced as session 8 ahead of Turnstile/CI.
   Randy's go becomes a walkthrough validation; whether the key later moves to a
   shop-account app is a cutover-time swap. The session verifies current Etsy API
   docs before building — the 2026-08-09 investigation is eleven months old.*
